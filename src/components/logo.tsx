...
const Logo = ({ className }: { className?: string }) => (
  ...
  >
    <path 
      ...
      strokeWidth="1.5"
    />
    <circle cx="9.5" cy="11" r="1.5" fill="hsl(220 70% 50%)" />
    <circle cx="14.5" cy="11" r="1.5" fill="hsl(220 70% 50%)" />
    ...
    <rect x="8" y="4" width="2" height="2" rx="1" fill="hsl(220 70% 50%)"/>
    <rect x="14" y="4" width="2" height="2" rx="1" fill="hsl(220 70% 50%)"/>
  </svg>
);
