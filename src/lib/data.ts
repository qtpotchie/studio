...
export const terms: Term[] = [
  ...
  },
  {
    ...
    term: 'AGP',
    slug: 'agp',
    definition: 'Accelerated Graphics Port (AGP) was a high-speed point-to-point channel for attaching a video card to a computer\'s motherboard, primarily to assist in the acceleration of 3D computer graphics.',
  ...
  },
  {
    ...
    term: 'AIO (All-in-One)',
    slug: 'aio',
    definition: 'An All-in-One (AIO) computer or device integrates the internal components into the same case as the display, eliminating the need for a separate computer tower.',
  ...
  },
  {
    ...
    term: 'AMD-V',
    slug: 'amd-v',
    definition: 'AMD-V (AMD Virtualization) is the name for AMD\'s hardware virtualization extensions for the x86 architecture, which enables running multiple operating systems on a single machine.',
  ...
  },
  {
    ...
    term: 'AMI BIOS',
    slug: 'ami-bios',
    definition: 'American Megatrends Inc. (AMI) BIOS is a type of firmware used to perform hardware initialization during the booting process on many PC motherboards.',
  ...
  },
  {
    ...
    term: 'APK',
    slug: 'apk',
    definition: 'An Android Package Kit (APK) is the file format used by the Android operating system for the distribution and installation of mobile apps.',
  ...
  },
  {
    ...
    term: 'ATX',
    slug: 'atx',
    definition: 'ATX (Advanced Technology eXtended) is a motherboard and power supply configuration specification developed by Intel to improve on previous standards.',
  ...
  },
  {
    ...
    term: 'Bluetooth LE',
    slug: 'bluetooth-le',
    definition: 'Bluetooth Low Energy (LE) is a power-conserving version of Bluetooth, designed for low-power devices that transmit small amounts of data infrequently.',
  ...
  {
    id: 'brb',
    term: 'BRB (Binary Rate Breakpoint)',
    slug: 'brb',
    definition: 'Binary Rate Breakpoint (BRB) is a term used in adaptive streaming where the video player switches between different quality levels (bitrates) based on network conditions.',
  ...
  },
  {
    ...
    term: 'BRUTEFORCE',
    slug: 'bruteforce',
    definition: 'A brute-force attack is a trial-and-error method used to obtain information such as a user password by trying all possible combinations.',
  ...
  },
  {
    ...
    term: 'CNAME',
    slug: 'cname',
    definition: 'A Canonical Name (CNAME) record is a type of DNS record that maps an alias name to a true or canonical domain name.',
  ...
  },
  {
    ...
    term: 'CGroup',
    slug: 'cgroup',
    definition: 'Control Groups (cgroups) are a Linux kernel feature that allows you to allocate and limit resources—like CPU, memory, and network I/O—among a collection of processes.',
  ...
  },
  {
    ...
    term: 'CRUD',
    slug: 'crud',
    definition: 'CRUD stands for Create, Read, Update, and Delete, which are the four basic operations of persistent storage.',
  ...
  },
  {
    ...
    term: 'CTOS',
    slug: 'ctos',
    definition: 'Convergent Technology Operating System (CTOS) was a modular, message-passing, multiprocessing operating system.',
  ...
  },
  {
    ...
    term: 'CUDA',
    slug: 'cuda',
    definition: 'CUDA (Compute Unified Device Architecture) is a parallel computing platform and programming model developed by Nvidia for general computing on its own GPUs.',
  ...
  },
  {
    ...
    term: 'DDoS',
    slug: 'ddos',
    definition: 'A Distributed Denial-of-Service (DDoS) attack is a malicious attempt to disrupt the normal traffic of a targeted server or network by overwhelming it with a flood of Internet traffic.',
  ...
  },
  {
    ...
    term: 'DDR3/DDR4/DDR5',
    slug: 'ddr3-ddr4-ddr5',
    definition: 'Double Data Rate Synchronous Dynamic Random-Access Memory (DDR SDRAM) are generations of memory (RAM) used in computers, with each new version offering higher speeds and more efficiency.',
  ...
  },
  {
    ...
    definition: 'Deep Packet Inspection (DPI) is an advanced method of examining network traffic, where the content of data packets is inspected in detail.',
  ...
  },
  {
    ...
    term: 'Disk I/O',
    slug: 'disk-io',
    definition: 'Disk Input/Output (I/O) refers to the read and write operations on a physical disk (hard drive or SSD).',
  ...
  },
  {
    ...
    term: 'DPI (Network)',
    slug: 'dpi-network',
    definition: 'Deep Packet Inspection (DPI) in networking is the process of examining the data part of a packet as it passes an inspection point, filtering for non-protocol-compliant traffic or specific content.',
  ...
  },
  {
    ...
    term: 'Dual-boot',
    slug: 'dual-boot',
    definition: 'Dual-booting is the act of installing two operating systems on a single computer, and being able to choose which one to boot into when the computer starts.',
  ...
  },
  {
    ...
    term: 'ECDSA',
    slug: 'ecdsa',
    definition: 'The Elliptic Curve Digital Signature Algorithm (ECDSA) is a cryptographic algorithm used to create a digital signature of data to verify its authenticity and integrity.',
  ...
  },
  {
    ...
    term: 'EXT4',
    slug: 'ext4',
    definition: 'The fourth extended filesystem (ext4) is a journaling file system for Linux, developed as the successor to ext3.',
  ...
  },
  {
    ...
    term: 'ETag',
    slug: 'etag',
    definition: 'An ETag (entity tag) is an HTTP header used for web cache validation. It allows a server to indicate whether a resource has changed, enabling browsers to use a cached version instead of re-downloading it.',
  ...
  },
  {
    ...
    term: 'Fiber Channel',
    slug: 'fiber-channel',
    definition: 'Fibre Channel is a high-speed data transfer protocol providing in-order, lossless delivery of raw block data, primarily used to connect computer data storage to servers in storage area networks (SAN).',
  ...
  },
  {
    ...
    definition: 'A firewall ruleset is the collection of rules configured on a firewall that determines whether network traffic should be allowed or blocked.',
  ...
  },
  {
    ...
    term: 'FLoC',
    slug: 'floc',
    definition: 'Federated Learning of Cohorts (FLoC) was a privacy-focused web standard proposal by Google for interest-based advertising, intended as a replacement for third-party cookies.',
  ...
  },
  {
    ...
    term: 'Frontend Build',
    slug: 'frontend-build',
    definition: 'A frontend build is the process of compiling, transforming, and bundling web assets (like JavaScript, CSS, and images) into optimized files for a web browser.',
  ...
  },
  {
    ...
    definition: 'Passive mode is a mode for FTP connections where the client, rather than the server, initiates the data connection, which helps bypass firewalls on the client side.',
  ...
  },
  {
    ...
    term: 'Full-Duplex',
    slug: 'full-duplex',
    definition: 'Full-duplex refers to the transmission of data in two directions simultaneously. An example is a telephone call, where both parties can speak and be heard at the same time.',
  ...
  },
  {
    ...
    term: 'GCC',
    slug: 'gcc',
    definition: 'The GNU Compiler Collection (GCC) is a compiler system produced by the GNU Project supporting various programming languages.',
  ...
  },
  {
    ...
    term: 'GDB',
    slug: 'gdb',
    definition: 'The GNU Debugger (GDB) is a portable debugger that runs on many Unix-like systems and works for many programming languages, including C, C++, and Go.',
  ...
  },
  {
    ...
    term: 'Geth (Ethereum)',
    slug: 'geth-ethereum',
    definition: 'Geth (Go Ethereum) is one of the original and most popular command-line clients for the Ethereum blockchain, written in the Go programming language.',
  ...
  },
  {
    ...
    term: 'Git Stash',
    slug: 'git-stash',
    definition: '`git stash` is a command that temporarily shelves (or stashes) changes you\'ve made to your working copy so you can work on something else, and then come back and re-apply them later on.',
  ...
  },
  {
    ...
    term: 'GUI Thread',
    slug: 'gui-thread',
    definition: 'The GUI thread (or UI thread) is the main thread in a graphical application responsible for handling user input and drawing the user interface.',
  ...
  },
  {
    ...
    definition: 'A handshake is a process in networking where two communicating devices agree on protocols and parameters for communication before any data is transferred. An example is the TCP three-way handshake.',
  ...
  },
  {
    ...
    term: 'Heap Memory',
    slug: 'heap-memory',
    definition: 'Heap memory is a region of a computer\'s memory used for dynamic memory allocation, where objects are stored when a program is running.',
  ...
  },
  {
    ...
    term: 'Hibernate (OS)',
    slug: 'hibernate-os',
    definition: 'Hibernation is a power-saving state that saves the contents of your computer\'s RAM to the hard disk and then completely powers off the computer.',
  ...
  },
  {
    ...
    term: 'HMAC',
    slug: 'hmac',
    definition: 'Hash-based Message Authentication Code (HMAC) is a type of message authentication code involving a cryptographic hash function and a secret key, used to verify both the data integrity and authenticity of a message.',
  ...
  },
  {
    ...
    definition: 'A hook is a mechanism in programming that allows a developer to intercept or augment the behavior of a program or framework at specific points in its execution.',
  ...
  },
  {
    ...
    term: 'HyperThreading',
    slug: 'hyperthreading',
    definition: 'Hyper-Threading is Intel\'s proprietary technology for simultaneous multithreading (SMT), which allows a single physical CPU core to appear as two logical cores to the operating system.',
  ...
  },
  {
    ...
    term: 'IDE Cable',
    slug: 'ide-cable',
    definition: 'An IDE (Integrated Drive Electronics) cable, also known as a PATA cable, is a wide, flat ribbon cable used to connect older hard drives and optical drives to the motherboard.',
  ...
  },
  {
    ...
    definition: 'In an infix expression, operators are written in-between their operands, which is the standard way humans write mathematical expressions.',
  ...
  },
  {
    ...
    term: 'Init System',
    slug: 'init-system',
    definition: 'An init system is the first process started by the kernel during the booting of a computer. It is responsible for starting all other processes.',
  ...
  },
  {
    ...
    term: 'IPVS',
    slug: 'ipvs',
    definition: 'IP Virtual Server (IPVS) is built on top of the Netfilter framework and implements transport-layer load balancing as part of the Linux kernel.',
  ...
  },
  {
    ...
    term: 'Iterables',
    slug: 'iterables',
    definition: 'In programming, an iterable is an object that can be "iterated" over, meaning you can traverse through all the values. Examples include arrays, strings, and maps.',
  ...
  },
  {
    ...
    term: 'JAR',
    slug: 'jar',
    definition: 'A JAR (Java Archive) is a package file format typically used to aggregate many Java class files and associated metadata and resources into one file for distribution.',
  ...
  },
  {
    ...
    term: 'JSON Schema',
    slug: 'json-schema',
    definition: 'JSON Schema is a vocabulary that allows you to annotate and validate JSON documents, ensuring the data is in the correct format.',
  ...
  },
  {
    ...
    term: 'Kernel Space',
    slug: 'kernel-space',
    definition: 'Kernel space is the memory area where the core of the operating system (the kernel) resides and has unrestricted access to all hardware.',
  ...
  },
  {
    ...
    definition: 'A Key Derivation Function (KDF) is a cryptographic function that derives one or more secret keys from a secret value such as a master key or a password.',
  ...
  },
  {
    ...
    term: 'Kubernetes Pod',
    slug: 'kubernetes-pod',
    definition: 'A Pod is the smallest and simplest unit in the Kubernetes object model that you create or deploy. A Pod represents a running process on your cluster and can contain one or more containers.',
  ...
  },
  {
    ...
    term: 'LAMP Stack',
    slug: 'lamp-stack',
    definition: 'LAMP is an acronym for a popular open-source web development stack consisting of Linux (Operating System), Apache (Web Server), MySQL (Database), and PHP/Python/Perl (Programming Language).',
  ...
  },
  {
    ...
    term: 'LDAP',
    slug: 'ldap',
    definition: 'The Lightweight Directory Access Protocol (LDAP) is an open, vendor-neutral, industry standard application protocol for accessing and maintaining distributed directory information services over an IP network.',
  ...
  },
  {
    ...
    term: 'LFS (Large File Storage)',
    slug: 'lfs-large-file-storage',
    definition: 'Git Large File Storage (LFS) is a Git extension that replaces large files such as audio samples, videos, and datasets with text pointers inside Git, while storing the file contents on a remote server.',
  ...
  },
  {
    ...
    term: 'LRU Cache',
    slug: 'lru-cache',
    definition: 'A Least Recently Used (LRU) cache is a cache replacement algorithm that discards the least recently used items first when the cache is full.',
  ...
  },
  {
    ...
    definition: 'In assembly language, a macro is a named block of code that can be inserted into a program. It\'s a way to reuse common sequences of instructions.',
  ...
  },
  {
    ...
    definition: 'A Man-in-the-Middle (MITM) attack is a cyberattack where the attacker secretly relays and possibly alters the communication between two parties who believe they are directly communicating with each other.',
  ...
  },
  {
    ...
    term: 'Markup',
    slug: 'markup',
    definition: 'A markup language is a system for annotating a document in a way that is syntactically distinguishable from the text, such as HTML for web pages.',
  ...
  },
  {
    ...
    term: 'MBR vs GPT',
    slug: 'mbr-vs-gpt',
    definition: 'Master Boot Record (MBR) and GUID Partition Table (GPT) are two different ways of storing the partitioning information on a drive. GPT is the modern standard, supporting larger drives and more partitions.',
  ...
  },
  {
    ...
    term: 'MDC Hash',
    slug: 'mdc-hash',
    definition: 'Modification Detection Code (MDC) is a type of message digest or cryptographic hash function used to verify the integrity of a message.',
  ...
  },
  {
    ...
    term: 'MIG (Nvidia)',
    slug: 'mig-nvidia',
    definition: 'Multi-Instance GPU (MIG) is a technology from Nvidia that allows a single GPU to be partitioned into multiple, isolated GPU instances, each with its own memory and compute resources.',
  ...
  },
  {
    ...
    term: 'MinGW',
    slug: 'mingw',
    definition: 'MinGW (Minimalist GNU for Windows) is a development environment that provides a port of the GNU Compiler Collection (GCC) and other tools for creating native Windows applications.',
  ...
  },
  {
    ...
    term: 'Mint Linux',
    slug: 'mint-linux',
    definition: 'Linux Mint is a community-driven Linux distribution based on Ubuntu, known for its user-friendliness and traditional desktop experience.',
  ...
  },
  {
    ...
    definition: 'A replica set in MongoDB is a group of `mongod` processes that maintain the same data set, providing redundancy and high availability.',
  ...
  },
  {
    ...
    term: 'Monolith',
    slug: 'monolith',
    definition: 'A monolithic architecture is a traditional software design model where an application is built as a single, indivisible unit. The opposite of a microservices architecture.',
  ...
  },
  {
    ...
    term: 'MQTT',
    slug: 'mqtt',
    definition: 'MQTT (Message Queuing Telemetry Transport) is a lightweight, publish-subscribe network protocol that transports messages between devices, often used for IoT applications.',
  ...
  },
  {
    ...
    term: 'MUX',
    slug: 'mux',
    definition: 'A multiplexer (or MUX) is a device that selects one of several analog or digital input signals and forwards the selected input into a single line.',
  ...
  },
  {
    ...
    term: 'MySQL Dump',
    slug: 'mysql-dump',
    definition: '`mysqldump` is a command-line utility used to create a logical backup of a MySQL or MariaDB database, generating a SQL file with `CREATE TABLE` and `INSERT` statements.',
  ...
  },
  {
    ...
    term: 'NAS',
    slug: 'nas',
    definition: 'Network-Attached Storage (NAS) is a dedicated file storage server that provides local-area network nodes with file-based shared storage through a standard Ethernet connection.',
  ...
  },
  {
    ...
    term: 'NaCl (Networking Library)',
    slug: 'nacl-networking-library',
    definition: 'NaCl (pronounced "salt") is a high-speed software library for network communication, encryption, decryption, signatures, etc. Its goal is to provide a simple, high-level API for cryptography.',
  ...
  },
  {
    ...
    term: 'Netcat',
    slug: 'netcat',
    definition: 'Netcat (`nc`) is a versatile command-line networking utility for reading from and writing to network connections using TCP or UDP.',
  ...
  },
  {
    ...
    term: 'NFS',
    slug: 'nfs',
    definition: 'The Network File System (NFS) is a distributed file system protocol that allows a user on a client computer to access files over a computer network much like local storage is accessed.',
  ...
  },
  {
    ...
    definition: 'Nginx can be configured as a reverse proxy, which is a server that sits in front of one or more web servers, forwarding client requests to them. This is useful for load balancing, caching, and SSL termination.',
  ...
  },
  {
    ...
    term: 'Nim Language',
    slug: 'nim-language',
    definition: 'Nim is a statically typed, compiled systems programming language that is known for its performance, expressive syntax, and ability to compile to C, C++, or JavaScript.',
  ...
  },
  {
    ...
    term: 'Nonce',
    slug: 'nonce',
    definition: 'In cryptography, a nonce ("number used once") is an arbitrary number that can be used just once in a cryptographic communication. It helps prevent replay attacks.',
  ...
  },
  {
    ...
    term: 'NoSQL',
    slug: 'nosql',
    definition: 'A NoSQL database provides a mechanism for storage and retrieval of data that is modeled in means other than the tabular relations used in relational databases. Examples include document, key-value, and graph databases.',
  ...
  },
  {
    ...
    term: 'OCSP',
    slug: 'ocsp',
    definition: 'The Online Certificate Status Protocol (OCSP) is an Internet protocol used for obtaining the revocation status of an X.509 digital certificate.',
  ...
  },
  {
    ...
    term: 'On-Prem',
    slug: 'on-prem',
    definition: 'On-premises (or on-prem) software is installed and runs on computers on the premises of the person or organization using the software, rather than at a remote facility such as a cloud provider\'s data center.',
  ...
  },
  {
    ...
    term: 'OpenShift',
    slug: 'openshift',
    definition: 'Red Hat OpenShift is a family of containerization software products, centered on a Kubernetes distribution packaged with additional tools for developers.',
  ...
  },
  {
    ...
    term: 'ORB (Robotics)',
    slug: 'orb-robotics',
    definition: 'ORB (Oriented FAST and Rotated BRIEF) is a feature detection algorithm in computer vision used for tasks like object recognition and 3D reconstruction in robotics.',
  ...
  },
  {
    ...
    term: 'PAN Network',
    slug: 'pan-network',
    definition: 'A Personal Area Network (PAN) is a computer network for interconnecting electronic devices within an individual person\'s workspace.',
  ...
  },
  {
    ...
    term: 'PCIe Lane',
    slug: 'pcie-lane',
    definition: 'A PCI Express (PCIe) lane consists of two differential signaling pairs, one for receiving and one for transmitting. The more lanes a PCIe slot has (e.g., x16), the more bandwidth it can provide.',
  ...
  },
  {
    ...
    term: 'PEM File',
    slug: 'pem-file',
    definition: 'A PEM (Privacy-Enhanced Mail) file is a Base64 encoded file format for storing cryptographic keys and certificates. It\'s a common format for SSL certificates.',
  ...
  },
  {
    ...
    term: 'PID Controller',
    slug: 'pid-controller',
    definition: 'A Proportional-Integral-Derivative (PID) controller is a control loop mechanism employing feedback that is widely used in industrial control systems and a variety of other applications requiring continuously modulated control.',
  ...
  },
  {
    ...
    term: 'Pipeline Cache',
    slug: 'pipeline-cache',
    definition: 'In CI/CD, a pipeline cache is used to store dependencies or other files that don\'t change often between runs, speeding up the build process.',
  ...
  },
  {
    ...
    term: 'Plasma Desktop',
    slug: 'plasma-desktop',
    definition: 'KDE Plasma is a popular desktop environment for Linux systems, known for its modern appearance and extensive customizability.',
  ...
  },
  {
    ...
    definition: 'A Proof of Concept (PoC) is a small exercise to test a design idea or assumption. The main purpose of developing a PoC is to demonstrate the functionality and to verify a certain concept or theory has the potential for real-world application.',
  ...
  },
  {
    ...
    term: 'Prisma ORM',
    slug: 'prisma-orm',
    definition: 'Prisma is a modern, open-source database toolkit and ORM (Object-Relational Mapper) for Node.js and TypeScript. It helps developers build applications faster and make fewer errors.',
  ...
  },
  {
    ...
    term: 'Process Fork',
    slug: 'process-fork',
    definition: 'A fork is an operation whereby a process creates a copy of itself. It is the primary method of process creation on Unix-like operating systems.',
  ...
  },
  {
    ...
    definition: 'Protocol Buffers (Protobuf) are a free and open-source cross-platform data format used to serialize structured data. It is useful in developing programs to communicate with each other over a network or for storing data.',
  ...
  },
  {
    ...
    term: 'PUA (Potentially Unwanted App)',
  ...
  },
  {
    ...
    definition: 'Quantum Key Distribution (QKD) is a secure communication method which implements a cryptographic protocol involving components of quantum mechanics. It allows two parties to produce a shared random secret key known only to them, which can then be used to encrypt and decrypt messages.',
  ...
  },
  {
    ...
    term: 'Query Planner',
    slug: 'query-planner',
    definition: 'A query planner (or query optimizer) is a component of a database management system that determines the most efficient way to execute a given query by considering various possible execution plans.',
  ...
  },
  {
    ...
    term: 'QuickSync',
    slug: 'quicksync',
    definition: 'Intel Quick Sync Video is Intel\'s brand for its dedicated video encoding and decoding hardware core. It is used to accelerate video processing tasks.',
  ...
  },
  {
    ...
    term: 'QWERTZ Layout',
    slug: 'qwertz-layout',
    definition: 'The QWERTZ layout is a keyboard layout widely used in Central Europe. The main difference from QWERTY is that the Z and Y keys are swapped.',
  ...
  },
  {
    ...
    term: 'RAID 0/1/5/10',
    slug: 'raid-0-1-5-10',
    definition: 'RAID (Redundant Array of Independent Disks) is a data storage virtualization technology that combines multiple physical disk drive components into one or more logical units for the purposes of data redundancy, performance improvement, or both. Common levels include RAID 0 (striping), RAID 1 (mirroring), RAID 5 (striping with parity), and RAID 10 (a combination of 1 and 0).',
  ...
  },
  {
    ...
    term: 'RAMDISK',
    slug: 'ramdisk',
    definition: 'A RAM disk is a block of RAM that a computer\'s software is treating as if the memory were a disk drive. It offers extremely fast access times.',
  ...
  },
  {
    ...
    definition: 'Raspberry Pi OS (formerly Raspbian) is a Debian-based operating system specifically optimized for the Raspberry Pi hardware.',
  ...
  },
  {
    ...
    term: 'Raster Image',
    slug: 'raster-image',
    definition: 'A raster image (or bitmap) is a data structure representing a grid of pixels. Common raster image formats include JPEG, PNG, and GIF.',
...

  {
    ...
    term: 'Redis Sentinel',
    slug: 'redis-sentinel',
    definition: 'Redis Sentinel provides high availability for Redis. It is a monitoring and failover system that automatically handles the process of promoting a replica to a master when the current master is down.',
  ...
  },
  {
    ...
    term: 'Refactor',
    slug: 'refactor',
    definition: 'Refactoring is the process of restructuring existing computer code—changing the factoring—without changing its external behavior. It is done to improve nonfunctional attributes of the software.',
  ...
  },
  {
    ...
    term: 'Registry Hive',
    slug: 'registry-hive',
    definition: 'A hive is a logical group of keys, subkeys, and values in the Windows Registry. Each hive is a file on the disk that contains a portion of the registry.',
  ...
  },
  {
    ...
    definition: 'In Kubernetes, a ReplicationController is a component that ensures a specified number of pod replicas are running at any one time.',
  ...
  },
  {
    ...
    term: 'RESTful API',
    slug: 'restful-api',
    definition: 'A RESTful API is an application programming interface that uses HTTP requests to GET, PUT, POST, and DELETE data, following the principles of Representational State Transfer (REST).',
  ...
  },
  {
    ...
    term: 'RPC',
    slug: 'rpc',
    definition: 'A Remote Procedure Call (RPC) is when a computer program causes a procedure (subroutine) to execute in a different address space (commonly on another computer on a shared network) without the programmer needing to explicitly code the details for the remote interaction.',
  ...
  },
  {
    ...
    term: 'SaltStack',
    slug: 'saltstack',
    definition: 'SaltStack (or Salt) is an open-source configuration management and remote execution tool. It is used to automate the management and configuration of servers.',
  ...
  },
  {
    ...
    term: 'SATA Port',
    slug: 'sata-port',
    definition: 'A SATA (Serial ATA) port is an interface on a computer\'s motherboard used to connect storage devices like hard drives and SSDs.',
  ...
  },
  {
    ...
    definition: 'A schema migration is the process of making incremental, reversible changes to a database schema, such as adding a new table or column, in a structured and version-controlled way.',
  ...
  },
  {
    ...
    term: 'SCP Protocol',
    slug: 'scp-protocol',
    definition: 'Secure Copy Protocol (SCP) is a means of securely transferring computer files between a local host and a remote host or between two remote hosts. It is based on the SSH protocol.',
  ...
  },
  {
    ...
    definition: 'Semantic Versioning (SemVer) is a versioning scheme for software that uses a three-part version number (MAJOR.MINOR.PATCH) to convey the nature of changes.',
  ...
  },
  {
    ...
    term: 'Serverless',
    slug: 'serverless',
    definition: 'Serverless computing is a cloud computing execution model in which the cloud provider runs the server, and dynamically manages the allocation of machine resources. Pricing is based on the actual amount of resources consumed.',
  ...
  },
  {
    ...
    term: 'SHA-256',
    slug: 'sha-256',
    definition: 'SHA-256 (Secure Hash Algorithm 256-bit) is a cryptographic hash function that produces a 256-bit (32-byte) hash value. It is widely used in security applications and cryptocurrencies like Bitcoin.',
  ...
  },
  {
    ...
    term: 'Shebang',
    slug: 'shebang',
    definition: 'A shebang (`#!`) is the character sequence at the beginning of a script file on Unix-like systems. It specifies the interpreter that should be used to execute the script.',
  ...
  },
  {
    ...
    definition: 'The singleton pattern is a software design pattern that restricts the instantiation of a class to one "single" instance. This is useful when exactly one object is needed to coordinate actions across the system.',
  ...
  },
  {
    ...
    term: 'SIP Trunk',
    slug: 'sip-trunk',
    definition: 'A SIP trunk is a virtual version of an analog phone line that uses the Session Initiation Protocol (SIP) to connect a private branch exchange (PBX) to the internet, allowing for VoIP calls.',
  ...
  },
  {
    ...
    term: 'SMB Share',
    slug: 'smb-share',
    definition: 'An SMB (Server Message Block) share is a shared resource (like a folder or printer) on a network that is made available using the SMB protocol, common in Windows networking.',
  ...
  },
  {
    ...
    term: 'SMTP Relay',
    slug: 'smtp-relay',
    definition: 'An SMTP relay is a service that routes email through a trusted third-party to send it to the recipient. This is often used to improve deliverability and avoid being marked as spam.',
  ...
  },
  {
    ...
    term: 'Source Mapping',
    slug: 'source-mapping',
    definition: 'A source map is a file that maps from the transformed source code back to the original source code. This is essential for debugging code that has been minified or transpiled.',
  ...
  },
  {
    ...
    term: 'SSL Handshake',
    slug: 'ssl-handshake',
    definition: 'The SSL/TLS handshake is the process where a client and server establish a secure communication channel. They agree on encryption protocols, exchange certificates, and generate session keys.',
  ...
  },
  {
    ...
    term: 'STP Cable',
    slug: 'stp-cable',
    definition: 'Shielded Twisted Pair (STP) is a type of copper telephone wiring in which the wires are twisted together and surrounded by a shielding material to protect them from electromagnetic interference.',
  ...
  },
  {
    ...
    term: 'sudoers',
    slug: 'sudoers',
    definition: 'The `sudoers` file, typically located at `/etc/sudoers`, is a file on Unix-like systems that controls which users are allowed to execute commands with superuser privileges using the `sudo` command.',
  ...
  },
  {
    ...
    term: 'Swap Memory',
    slug: 'swap-memory',
    definition: 'Swap memory (or a swap file) is a space on a hard disk that is used as virtual memory when the amount of physical RAM is full.',
  ...
  },
  {
    ...
    term: 'Symbolic Link',
    slug: 'symbolic-link',
    definition: 'A symbolic link (or symlink) is a type of file on Unix-like systems that serves as a reference to another file or directory.',
  ...
  },
  {
    ...
    term: 'TDP (CPU)',
    slug: 'tdp-cpu',
    definition: 'Thermal Design Power (TDP) is the maximum amount of heat generated by a computer chip or component (e.g. a CPU or GPU) that the cooling system is designed to dissipate under any workload.',
  ...
  },
  {
    ...
    term: 'Token Bucket',
    slug: 'token-bucket',
    definition: 'The token bucket is an algorithm used in packet switched computer networks and telecommunications networks to control the rate at which data is sent, allowing for bursts of traffic.',
  ...
  },
  {
    ...
    term: 'TOTP',
    slug: 'totp',
    definition: 'Time-based One-Time Password (TOTP) is an algorithm that computes a one-time password from a shared secret key and the current time. It is a common method for two-factor authentication.',
  ...
  },
  {
    ...
    term: 'TPM 2.0',
    slug: 'tpm-2-0',
    definition: 'A Trusted Platform Module (TPM) is a secure cryptoprocessor, a dedicated microcontroller designed to secure hardware through integrated cryptographic keys. Version 2.0 is a modern standard.',
  ...
  },
  {
    ...
    term: 'Trace Route',
    slug: 'trace-route',
    definition: 'Traceroute is a network diagnostic command for displaying possible routes (paths) and measuring transit delays of packets across an Internet Protocol (IP) network.',
  ...
  },
  {
    ...
    term: 'TTL (DNS)',
    slug: 'ttl-dns',
    definition: 'Time to Live (TTL) in DNS is a setting that tells the DNS resolver how long to cache a query before it should request a new one from the authoritative name server.',
  ...
  },
  {
    ...
    term: 'TTY',
    slug: 'tty',
    definition: 'In computing, tty is a command in Unix and Unix-like operating systems to print the file name of the terminal connected to standard input. It originally stood for Teletypewriter.',
  ...
  },
  {
    ...
    definition: 'TUN and TAP are virtual network kernel drivers. TUN simulates a layer 3 (network) device and TAP simulates a layer 2 (Ethernet) device. They are often used by VPN software.',
  ...
  },
  {
    ...
    definition: 'Two-Factor Authentication (2FA) is a security method that requires the user to provide two different authentication factors to verify themselves, such as a password and a code from their phone.',
  ...
  },
  {
    ...
    term: 'UMA (Unified Memory Arch)',
    slug: 'uma-unified-memory-arch',
    definition: 'Unified Memory Architecture (UMA) is a computer memory architecture where the CPU and GPU share the same system RAM, as opposed to the GPU having its own dedicated VRAM.',
  ...
  },
  {
    ...
    definition: 'A Microkernel (µ-kernel) is a type of operating system kernel that provides only the minimal mechanisms needed to implement an OS, such as address space management and inter-process communication.',
  ...
  },
  {
    ...
    term: 'Underclock',
    slug: 'underclock',
    definition: 'Underclocking is the practice of running a computer processor at a lower clock speed than it is rated for, to reduce power consumption and heat.',
  ...
  },
  {
    ...
    term: 'Unicode Escape',
    slug: 'unicode-escape',
    definition: 'A Unicode escape sequence is a way of representing a Unicode character using its code point in ASCII text, such as `\\u20AC` for the Euro symbol.',
  ...
  },
  {
    ...
    term: 'Unmarshalling',
    slug: 'unmarshalling',
    definition: 'Unmarshalling (or deserialization) is the process of transforming a representation of an object from a serialized format (like a string) back into a live object in memory.',
  ...
  },
  {
    ...
    term: 'Unmount',
    slug: 'unmount',
    definition: 'In computing, to unmount a disk or device is to make it inaccessible to the file system. It is the opposite of mounting.',
  ...
  },
  {
    ...
    definition: 'In Git, an upstream branch is the remote branch that a local branch is tracking. It is the branch you fetch from and push to.',
  ...
  },
  {
    ...
    term: 'URL Encoding',
    slug: 'url-encoding',
    definition: 'URL encoding, also known as percent-encoding, is a mechanism for encoding information in a Uniform Resource Identifier (URI) under certain circumstances. It replaces unsafe ASCII characters with a "%" followed by two hexadecimal digits.',
  ...
  },
  {
    ...
    term: 'Userland',
    slug: 'userland',
    definition: 'Userland (or user space) is the part of a computer\'s memory where user applications run. It is separate from the kernel space, which is reserved for the operating system.',
  ...
  },
  {
    ...
    term: 'UTM Machine',
    slug: 'utm-machine',
    definition: 'A Universal Turing Machine (UTM) is a theoretical Turing machine that can simulate an arbitrary Turing machine on arbitrary input. The UTM proves that it is possible to build a single, general-purpose computer.',
  ...
  },
  {
    ...
    term: 'Vectorization',
    slug: 'vectorization',
    definition: 'In computer science, vectorization is the process of converting an algorithm from a scalar implementation, which operates on a single pair of operands at a time, to a vector implementation, which operates on a set of operands at once. This is often done using SIMD instructions.',
  ...
  },
  {
    ...
    term: 'Wake-on-LAN',
    slug: 'wake-on-lan',
    definition: 'Wake-on-LAN (WOL) is an Ethernet or Token Ring computer networking standard that allows a computer to be turned on or awakened by a network message.',
  ...
  },
  {
    ...
    term: 'WebRTC',
    slug: 'webrtc',
    definition: 'WebRTC (Web Real-Time Communication) is a free, open-source project providing web browsers and mobile applications with real-time communication (RTC) via simple APIs.',
  ...
  },
  {
    ...
    term: 'WebSocket',
    slug: 'websocket',
    definition: 'WebSocket is a computer communications protocol, providing full-duplex communication channels over a single TCP connection. It is used for real-time applications like live chat and online gaming.',
  ...
  },
  {
    ...
    definition: 'Write-Ahead Logging (WAL) is a standard method for ensuring data integrity in database systems. All modifications are written to a log before they are applied to the database itself.',
  ...
  },
  {
    ...
    term: 'XAMP Stack',
    slug: 'xamp-stack',
    definition: 'XAMPP is a free and open-source cross-platform web server solution stack package developed by Apache Friends, consisting mainly of the Apache HTTP Server, MariaDB database, and interpreters for scripts written in the PHP and Perl programming languages.',
  ...
  },
  {
    ...
    term: 'x86_64',
    slug: 'x86_64',
    definition: 'x86-64 (also known as x64) is the 64-bit version of the x86 instruction set, the instruction set architecture for most modern desktop and laptop computers.',
  ...
  },
  {
    ...
    term: 'XML-RPC',
    slug: 'xml-rpc',
    definition: 'XML-RPC is a remote procedure call (RPC) protocol which uses XML to encode its calls and HTTP as a transport mechanism. It\'s a simpler predecessor to SOAP.',
  ...
  },
  {
    ...
    definition: 'YARN (Yet Another Resource Negotiator) is a core component of Apache Hadoop that is responsible for resource management and job scheduling.',
  ...
  },
  {
    ...
    term: 'Zsh',
    slug: 'zsh',
    definition: 'The Z shell (Zsh) is a Unix shell that can be used as an interactive login shell and as a command interpreter for shell scripting. It is an extended Bourne shell with a large number of improvements.',
  ...
  },
  {
    ...
    term: 'Zero-Day',
    slug: 'zero-day',
    definition: 'A zero-day vulnerability is a software security flaw that is known to the software vendor but doesn\'t have a patch in place to fix it. An attack using a zero-day vulnerability is a zero-day attack.',
  ...
  },
  {
    ...
    term: 'Zero-Trust',
    slug: 'zero-trust',
    definition: 'A Zero Trust security model is a strategic approach to cybersecurity that secures an organization by eliminating implicit trust and continuously validating every stage of a digital interaction.',
  ...
  },
  {
    ...
    definition: 'Apache ZooKeeper is a centralized service for maintaining configuration information, naming, providing distributed synchronization, and providing group services for large distributed systems.',
  ...
  },
  {
    ...
    definition: 'Thermal Interface Material (TIM), commonly called thermal paste, is a substance applied between a CPU/GPU and its heatsink to improve heat transfer.',
  ...
  },
  {
    ...
    term: 'Hard Reset',
    slug: 'hard-reset',
    definition: 'A hard reset is restarting a device by cutting and reapplying power, such as holding down the power button or unplugging it. It does not erase data.',
  ...
  },
  {
    ...
    term: 'Soft Reset',
    slug: 'soft-reset',
    definition: 'A soft reset is restarting a device through the operating system\'s restart function, allowing for a graceful shutdown of programs.',
  ...
  },
  {
    ...
    term: 'QoL Patch',
    slug: 'qol-patch',
    definition: 'A Quality of Life (QoL) patch is a software update that doesn\'t add major new features, but instead focuses on improving usability and user experience.',
  ...
  },
  {
    ...
    term: 'Overclock',
    slug: 'overclock',
    definition: 'Overclocking is the practice of increasing a component\'s clock rate, running it at a higher speed than it was designed to run.',
  ...
  },
  {
    ...
    term: 'Undervolt',
    slug: 'undervolt',
    definition: 'Undervolting is the process of reducing the voltage supplied to a component (like a CPU or GPU) to decrease heat output and power consumption, often without losing performance.',
  ...
  },
  {
    ...
    term: 'Boilerplate',
    slug: 'boilerplate',
    definition: 'Boilerplate code is sections of code that have to be included in many places with little or no alteration. It is often seen as "fluff" that is required by the language or framework.',
  ...
  },
  {
    ...
    term: 'Tech Debt',
    slug: 'tech-debt',
    definition: 'Technical debt is a concept in software development that reflects the implied cost of rework caused by choosing an easy (limited) solution now instead of using a better approach that would take longer.',
  ...
  },
  {
    ...
    term: 'Bitbanging',
    slug: 'bitbanging',
    definition: 'Bit-banging is a technique for serial communications using software instead of dedicated hardware. A programmer rapidly toggles the state of a GPIO pin to manually generate the signal waveform.',
  ...
  },
  {
    ...
    term: 'Memory Thrash',
    slug: 'memory-thrash',
    definition: 'Memory thrashing occurs when a system spends an excessive amount of time swapping data between RAM and virtual memory on disk, leading to severe performance degradation.',
  ...
  },
  {
    ...
    term: 'Disk Thrash',
    slug: 'disk-thrash',
    definition: 'Disk thrashing is a condition where a hard drive is being overworked by excessive read/write operations, causing a grinding or clicking noise and very slow performance.',
  ...
  },
  {
    ...
    term: 'Headcrash',
    slug: 'headcrash',
    definition: 'A head crash is a catastrophic failure of a hard disk drive where the read-write head comes into contact with the spinning platters, physically destroying the drive and the data on it.',
  ...
  },
  {
    ...
    term: 'Cloud Bursting',
    slug: 'cloud-bursting',
    definition: 'Cloud bursting is an application deployment model in which an application runs in a private cloud or data center and "bursts" to a public cloud when the demand for computing capacity spikes.',
  ...
  },
  {
    ...
    term: 'Rage Click',
    slug: 'rage-click',
    definition: 'A rage click is when a user repeatedly and rapidly clicks on a button or link in frustration because the application is not responding.',
  ...
  },
  {
    ...
    definition: 'Null byte injection is a security exploit where an attacker injects a null byte character (`%00`) into user-provided data to bypass security checks and manipulate strings in languages like C/C++.',
